  ...
  UPDATE_USER_INFO (state, payload) {
    ...
    for (const property of Object.keys(payload)) {
      if (payload[property] !== null) {
        ...
        if(property == 'name')
        {
          state.AppActiveUser['displayName'] = payload[property]
          userInfo['displayName'] = payload[property]
        }

        if(property == 'id')
        {
          state.AppActiveUser['uid'] = payload[property]
          userInfo['uid'] = payload[property]
        }
      }
